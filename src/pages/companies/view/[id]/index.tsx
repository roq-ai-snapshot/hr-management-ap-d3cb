...
import { HrListPage } from 'pages/hrs';
    ...
    >
      <Box rounded="md">
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('company', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/companies/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="company" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
              ...
              >
                ...
                <FormListItem label="Address" text={data?.address} />

                <FormListItem label="Phone" text={data?.phone} />

                <FormListItem label="Website" text={data?.website} />
