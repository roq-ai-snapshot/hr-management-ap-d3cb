...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'hr-manager', 'employee', 'hr-assistant', 'applicant'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Hrs', path: '/hrs', entity: 'hr', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
    { name: 'Jobs', path: '/jobs', entity: 'job', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
